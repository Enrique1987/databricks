...
> [!CAUTION]
> These are decision patterns, not copy-paste production designs. Validate connector support, idempotency, schema evolution, checkpoint retention, delete handling, and cost for the specific source and cloud.
