...
Depth should serve a design decision, exam scenario, or clear architectural explanation. Keep low-value implementation internals in a parking lot until they affect one of those outcomes.
...
The current official exam guide governs certification scope. Official partner channels must confirm eligibility. Use English in all visual artifacts. Do not equate Partner Champion with Community Champion.

Public repository boundary: keep employer identity/tier details, private partner material, credential identifiers, and nomination correspondence outside Git. Record only sanitized completion status and public evidence links.
