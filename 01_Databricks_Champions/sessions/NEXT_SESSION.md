...
1. Minutes 0–3: re-test RAG versus training, embedding versus ID, and what vector search computes.
2. Minutes 3–9: explain ingestion, cleaning, chunking, embedding, storage, and indexing.
3. Minutes 9–13: explain query embedding, authorized retrieval/filtering, optional re-ranking, context construction, generation, and evaluation. Enforce access restrictions before unauthorized text reaches the model.
4. Minutes 13–18: answer Q1–Q4 in [the question bank](../genai-associate/QUESTION_BANK.md).
